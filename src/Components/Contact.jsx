            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        <p className="text-red-600 uppercase text-xl mb-4 font-semibold tracking-wider">
                            CONTACT US
                        </p>
                        <h2 className="text-3xl font-bold leading-relaxed mb-4">
                            GET IN TOUCH <br/>
                            <span className="text-red-600 leading-relaxed">REACH OUT TO US</span>
                        </h2>
                    </div>
                    ...
                    <div className="flex justify-center">
                        <div className="w-full max-w-md space-y-8">
                            ...
                            />
                            <button className="bg-red-600 text-white w-full py-5 font-semibold mt-6 transition-colors hover:bg-red-700">
                                SEND MESSAGE →
                            </button>
                        </div>
                    </div> 
