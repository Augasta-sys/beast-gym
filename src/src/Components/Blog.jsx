    ...
    <section id="blog" className="translate-y-90 lg:translate-y-130 lg:translate-x-5 py-24 bg-white text-white">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-red-600 font-oswald text-4xl font-bold uppercase">
            BLOG
          </h2>
          <p className="text-gray-400 font-raleway text-xl leading-10 uppercase mt-3 tracking-widest">
          ...
          {blogs.map((blog, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-3 right-3 bg-red-600 text-white font-oswald text-xl px-4 py-3 shadow-md">
                  22 NOV
                </div>
              ...
              {/* Content */}
              <div className="p-5">
                <h3 className="font-bold font-oswald text-lg group-hover:text-red-500 transition">
                  {blog.title}
                </h3>
                <p className="text-gray-400 font-raleway mt-3 text-sm">
                  {blog.desc}
                </p>
              </div>
